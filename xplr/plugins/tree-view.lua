...
local function setup(args)
  ...
  args.open_expansion_mode = args.open_expansion_mode or "default"
  args.open_expansion_key = args.open_expansion_key or "right"

  args.close_expansion_mode = args.close_expansion_mode or "default"
  args.close_expansion_key = args.close_expansion_key or "left"
  ...
  xplr.config.modes.builtin[args.open_expansion_mode].key_bindings.on_key[args.open_expansion_key] =
    {
      help = "open expansion",
      messages = {
        "PopMode",
        { CallLuaSilently = "custom.tree_view.open" },
      },
    }

  xplr.config.modes.builtin[args.close_expansion_mode].key_bindings.on_key[args.close_expansion_key] =
    {
      help = "close expansion",
      messages = {
        "PopMode",
